---
title: "Assignment4_B04704016ªL®a¼Ý"
...
# Set input data and generate models
...
# Conclusion:
# The inferences are quite similar to the results of graph in lower-right in part(b), because both predictions drop Seychelles out of the models. Also, both models consider the interactions between variables.
```
# Question 2 (a)
```{r, message=FALSE}
# Load data
